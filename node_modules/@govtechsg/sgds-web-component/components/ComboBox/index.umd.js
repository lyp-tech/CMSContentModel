(function (factory) {
  ...
  */
  ...
  var css_248z$a = css`.invalid-feedback-container{display:flex;gap:var(--sgds-form-gap-sm)}.invalid-feedback,.invalid-feedback-container{color:var(--sgds-form-danger-color-default);line-height:var(--sgds-line-height-min)}.invalid-feedback{font-size:var(--sgds-font-size-1);font-weight:var(--sgds-font-weight-regular)}.valid-icon{color:var(--sgds-form-success-color-default)}`;

  var css_248z$9 = css`.form-text{color:var(--sgds-form-color-subtle);font-size:var(--sgds-font-size-1);line-height:var(--sgds-line-height-min)}.form-text.disabled{opacity:var(--sgds-opacity-50)}`;
  ...
  SgdsIcon.styles = [...SgdsElement.styles, css_248z$5];
  __decorate([
      property({ type: String, reflect: true })
  ...
  var css_248z$4 = css`.form-label{color:var(--sgds-form-color-default);margin-bottom:0}.form-label.disabled{opacity:var(--sgds-opacity-50)}.form-check-label{color:var(--sgds-form-color-default)}.form-check-input:disabled~.form-check-label,.form-check-input[disabled]~.form-check-label{cursor:not-allowed}`;

  var css_248z$3 = css`.form-control::placeholder{color:var(--sgds-form-color-subtle);font-family:var(--sgds-font-family-brand);font-weight:var(--sgds-font-weight-light);line-height:var(--sgds-line-height-body)}`;
  ...
  FormControlElement.styles = [...SgdsElement.styles, css_248z$a, css_248z$9, css_248z$4, css_248z$3];
  __decorate([
      property({ reflect: true })
  ...
  ComboBoxItem.styles = [css_248z$1];
  __decorate([
      property({ type: Boolean, reflect: true })
  ...
  SgdsComboBox.styles = [...DropdownListElement.styles, css_248z$6, css_248z$9, css_248z$a, css_248z];
  /** @internal */
