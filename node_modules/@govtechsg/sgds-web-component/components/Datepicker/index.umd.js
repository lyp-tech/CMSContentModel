(function (factory) {
  ...
  */
  ...
  ButtonElement.styles = [...SgdsElement.styles, css_248z$g];
  __decorate([
      query(".btn")
  ...
  var css_248z$e = css`:host{display:inline-block}.btn.full-width,:host([fullWidth]){width:100%}.btn.full-width.has-left-icon{justify-content:flex-start}.btn.full-width.has-right-icon{justify-content:space-between}.btn.full-width.has-left-icon.has-right-icon{justify-content:center}.btn span{padding:0 var(--sgds-padding-2-xs)}`;
  ...
  SgdsButton.styles = [...ButtonElement.styles, css_248z$f, css_248z$e];
  __decorate([
      state()
  ...
  DatepickerCalendar.styles = [css_248z$c];
  /** @internal */
  ...
  SgdsIcon.styles = [...SgdsElement.styles, css_248z$b];
  __decorate([
      property({ type: String, reflect: true })
  ...
  SgdsIconButton.styles = [...ButtonElement.styles, css_248z$a];
  /** @internal */
  ...
  var css_248z$9 = css`.datepicker-header{display:flex;gap:var(--sgds-form-gap-md)}sgds-button{--btn-font-weight:var(--sgds-font-weight-semibold)}`;
  ...
  DatepickerHeader.styles = [css_248z$9];
  /** @internal */
  ...
  var css_248z$8 = css`.invalid-feedback-container{display:flex;gap:var(--sgds-form-gap-sm)}.invalid-feedback,.invalid-feedback-container{color:var(--sgds-form-danger-color-default);line-height:var(--sgds-line-height-min)}.invalid-feedback{font-size:var(--sgds-font-size-1);font-weight:var(--sgds-font-weight-regular)}.valid-icon{color:var(--sgds-form-success-color-default)}`;

  var css_248z$7 = css`.form-text{color:var(--sgds-form-color-subtle);font-size:var(--sgds-font-size-1);line-height:var(--sgds-line-height-min)}.form-text.disabled{opacity:var(--sgds-opacity-50)}`;

  var css_248z$6 = css`.form-label{color:var(--sgds-form-color-default);margin-bottom:0}.form-label.disabled{opacity:var(--sgds-opacity-50)}.form-check-label{color:var(--sgds-form-color-default)}.form-check-input:disabled~.form-check-label,.form-check-input[disabled]~.form-check-label{cursor:not-allowed}`;

  var css_248z$5 = css`.form-control::placeholder{color:var(--sgds-form-color-subtle);font-family:var(--sgds-font-family-brand);font-weight:var(--sgds-font-weight-light);line-height:var(--sgds-line-height-body)}`;
...
/*! CSS Used keyframes */@keyframes spinner{to{transform:rotate(1turn)}}.sr-only{clip:rect(0,0,0,0);border:0;height:1px;overflow:hidden;padding:0;position:absolute;white-space:nowrap;width:1px}`;
  ...
  var css_248z$1 = css`.input-container{display:flex;flex-direction:row;width:-webkit-fill-available;width:-moz-available}.form-control-group{border-right:0}.input-feedback{display:flex;flex-direction:column;width:-webkit-fill-available;width:-moz-available}.calendar-btn{all:unset}`;
  ...
  DatepickerInput.styles = [...SgdsInput.styles, css_248z$1];
  __decorate([
      property({ type: String })
  ...
  SgdsDatepicker.styles = [...DropdownElement.styles, css_248z$d, css_248z];
  /**@internal */
