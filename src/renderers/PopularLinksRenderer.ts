...
export class PopularLinksRenderer {
  ...
  constructor(options: PopularLinksOptions) {
    this.options = {
      containerClass: 'max-w-6xl mx-auto pl-8 md:pl-24 pb-0 md:pb-8',
      sectionClass: 'flex-1 min-w-[220px] bg-white rounded-lg shadow p-8 flex flex-col items-start',
      titleClass: 'text-lg font-semibold mb-3 block',
